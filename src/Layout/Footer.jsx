...
function Footer() {
    return (
        <footer className="bg-pink-500 dark:bg-gray-950">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-slate-100 uppercase dark:text-white">Legal</h2>
                            <ul className="text-slate-100 dark:text-slate-100 font-medium">
                                <li className="mb-4">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex mt-4 sm:justify-center sm:mt-0">
                        ...
                        <a href="#" className="text-slate-100 hover:text-slate-100 dark:hover:text-white ms-5">
